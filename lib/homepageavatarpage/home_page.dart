      ...
      body: Column(children: [
        ...
        isVisible == true 
            ...
            : Center(
                ...
                child: Text(
                  "Seninle tanışmak güzel, aramıza Hoş Geldin, Lütfen yukarıdaki seçeneklerden ilgi alanını seçerek, bizimle paylaşır mısın? (Şimdilik Sadece Kodlama Kısmında Çalışıyoruz, anlayışın için teşekkürler.)",
